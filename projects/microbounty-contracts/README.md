# 🛡️ MicroBounty Contracts
#### *The On-Chain Escrow & Payout Engine*

This project contains the **Algorand Smart Contracts** for MicroBounty. Built using **Algorand Python (Puya)** and orchestrated via **AlgoKit**.
...
By default the template creates a single `HelloWorld` contract under bounty folder in the `smart_contracts` directory. To add a new contract:
