# 🛡️ MicroBounty Frontend
#### *The Premium Bounty Dashboard*

The user-facing side of the MicroBounty ecosystem. Built with **React**, **Tailwind CSS**, and **Framer Motion**, featuring a glassmorphic aesthetic and real-time synchronization with both **Algorand** and **Supabase**.
